    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new User() { UserName = model.UserName, Email = model.Email, DateOfBirth = model.DateOfBirth, ConfirmationToken = confirmationToken, IsConfirmed = false };
        ...
        public ActionResult ConfirmRegistration(String confirmationtoken)
        {
            return ConfirmAccount(confirmationtoken)
                ...
                : RedirectToAction("ConfirmationFail");
        }

        public ActionResult ConfirmationFail()
        {
            return RedirectToAction("Index", "Home");
        }
    }
